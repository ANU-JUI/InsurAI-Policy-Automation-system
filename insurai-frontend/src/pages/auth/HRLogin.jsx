  ...
  return (
    <div
      ...
      style={{
        minHeight: "100vh",
        width: "100vw",
        background: "linear-gradient(135deg, #7455bcff 0%, #c612e2ff 100%)",
        padding: "20px",
      ...
      >
        <div className="row g-0">
          ...
          <div 
            ...
            style={{
              background: "linear-gradient(135deg, #3d0ab2ff 0%, #a314caff 100%)",
              position: "relative",
              overflow: "hidden",
            }}
          >
                ...
                <div className="d-flex align-items-center">
                  <div
                    style={{
                      width: "40px",
                      height: "40px",
                      background: "rgba(207, 26, 201, 0.2)",
                      borderRadius: "10px",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
            ...
            <div
              style={{
                ...
                width: "100px",
                height: "100px",
                background: "radial-gradient(circle, rgba(103, 12, 146, 0.3) 0%, transparent 70%)",
                borderRadius: "50%",
              }}
            />
            <div
            ...
            <div className="p-4 p-md-5">
              ...
              <div className="text-center mb-4">
                <div
                  style={{
                    width: "70px",
                    height: "70px",
                    background: "linear-gradient(135deg, #f529cfff, #6228e8ff)",
                    borderRadius: "16px",
                    margin: "0 auto 16px",
                    display: "flex",
                    alignItems: "center",
              ...
              <form onSubmit={handleLogin} autoComplete="on">
                ...
                <button
                  ...
                  style={{
                    borderRadius: "10px",
                    background: "linear-gradient(135deg, #8e1aecff, #430cc5ff)",
                    border: "none",
                    color: "white",
                    padding: "14px",
                    fontSize: "1rem",
                  ...
                  onMouseLeave={(e) => {
                    if (!loading) {
                      ...
                      e.target.style.boxShadow = "0 4px 15px rgba(174, 23, 229, 0.3)";
                    }
                  }}
                >
                  {loading ? (
