...
export default function EmployeeRegister() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const res = await fetch("https://insurai-policy-automation-system-backend.onrender.com/auth/register", {
        method: "POST",
  ...
  return (
    <div
      ...
      style={{
        minHeight: "100vh",
        width: "100vw",
        background: "linear-gradient(135deg, #b6dc1dff 0%, #091d01ff 50%, #126707ff 100%)",
        padding: "0",
        margin: "0",
      ...
      >
        <div className="row g-0">
          ...
          <div 
            ...
            style={{
              background: "linear-gradient(135deg, #309206a5 0%, #087826ff 100%)",
              position: "relative",
              overflow: "hidden",
            }}
          >
            <div className="p-5 d-flex flex-column justify-content-between text-white">
                ...
                <div className="d-flex align-items-center mb-4">
                  <div
                    style={{
                      width: "50px",
                      height: "50px",
                      background: "rgba(144, 48, 48, 0.94)",
                      borderRadius: "12px",
                      display: "flex",
                      alignItems: "center",
              ...
              <div className="mb-5">
                <div className="d-flex align-items-center mb-2">
                  ...
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fbfaf6ff" strokeWidth="2">
                ...
                <div className="d-flex align-items-center mb-2">
                  <div
                    style={{
                      width: "40px",
                      height: "40px",
                      background: "rgba(124, 207, 86, 0.93)",
                      borderRadius: "10px",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                  ...
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#92e387ff" strokeWidth="2">
                ...
                <div className="d-flex align-items-center">
                  <div
                    style={{
                      width: "40px",
                      height: "40px",
                      background: "rgba(202, 178, 75, 0.2)",
                      borderRadius: "10px",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
            ...
            <div
              style={{
                ...
                width: "100px",
                height: "100px",
                background: "radial-gradient(circle, rgba(236, 133, 7, 0.3) 0%, transparent 70%)",
                borderRadius: "50%",
              }}
            />
            <div
  ...
  style={{
    background:
      "linear-gradient(180deg, rgba(167, 219, 94, 1) 0%, rgba(181, 228, 100, 1) 100%)",
  }}
>

            <div className="p-2 p-md-3">
              {/* Header */}
              {/* ===== Premium Rating / Trust Box ===== */}
<div
  style={{
    background: "linear-gradient(135deg, rgba(32,108,149,0.18), rgba(27,38,44,0.18))",
    borderRadius: "16px",
    padding: "18px 20px",
    marginBottom: "28px",
    border: "1px solid rgba(32,108,149,0.25)",
...
>
  ...
  <div className="d-flex justify-content-center mb-2">
    {Array.from({ length: 5 }).map((_, i) => (
      ...
      >
        <path d="M12 .587l3.668 7.568L24 9.423l-6 5.851L19.335 24 12 20.012 4.665 24 6 15.274 0 9.423l8.332-1.268z" />
      </svg>
    ))}
  </div>
  ...
  <p
    ...
    style={{ fontSize: "0.95rem", color: "#1b262c" }}
  >
    Rated 4.9 / 5 by 10,000+ Employees
  </p>
  ...
  >
    “InsurAI made insurance management effortless and transparent.
    The AI features save us hours every week.”
  </p>
</div>
              ...
              <form onSubmit={handleRegister}>
                <div className="mb-2">
                  ...
                  <div className="position-relative">
                    <input
                      ...
                      onFocus={(e) => {
                        e.target.style.borderColor = "#111ed3ff";
                        e.target.style.boxShadow = "0 0 0 3px rgba(189, 196, 200, 0.95)";
                      }}
                      onBlur={(e) => {
                ...
                <div className="mb-2">
                  <label className="form-label fw-semibold" style={{ color: "#f26d07ff", fontSize: "0.9rem" }}>
                    Full Name
                  </label>
                  <div className="position-relative">
                    <input
                      ...
                      onFocus={(e) => {
                        e.target.style.borderColor = "#d46918ff";
                ...
                <div className="mb-2">
                  <label className="form-label fw-semibold" style={{ color: "#ed820fff", fontSize: "0.9rem" }}>
                    Email Address
                  </label>
                  <div className="position-relative">
                    <input
                      ...
                      onFocus={(e) => {
                        e.target.style.borderColor = "#f56518ff";
                        e.target.style.boxShadow = "0 0 0 3px rgba(3, 34, 50, 0.88)";
                      }}
                      onBlur={(e) => {
                        e.target.style.borderColor = "#e0e0e0";
                        e.target.style.boxShadow = "none";
                ...
                <div className="mb-4">
                  <label className="form-label fw-semibold" style={{ color: "#e68e0cff", fontSize: "0.9rem" }}>
                    Password
                  </label>
                  <div className="position-relative">
                    <input
