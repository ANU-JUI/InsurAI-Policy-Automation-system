  ...
  return (
    <div
      ...
      style={{
        minHeight: "100vh",
        width: "100vw",
        background: "linear-gradient(135deg, #f3efefff 0%, #f72509ff 100%)",
        padding: "0",
        margin: "0",
      ...
      >
        <div className="row g-0">
          ...
          <div 
            ...
            style={{
              background: "linear-gradient(135deg, #b0122dff 0%, #330202ff 100%)",
              position: "relative",
              overflow: "hidden",
            }}
          >
            <div className="p-5 d-flex flex-column justify-content-between text-white">
              ...
              <div className="mb-5">
                ...
                <div className="d-flex align-items-center mb-3">
                  ...
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#741007ff" strokeWidth="2">
            ...
            <div className="p-4 p-md-5">
              ...
              <div className="text-center mb-4">
                <div
                  style={{
                    width: "70px",
                    height: "70px",
                    background: "linear-gradient(135deg, #cf2929ff, #6e0505ff)",
                    borderRadius: "16px",
                    margin: "0 auto 16px",
                    display: "flex",
                    alignItems: "center",
                ...
                <h3 className="fw-bold" style={{ color: "#580303ff" }}>Admin Login</h3>
                <p className="text-muted mb-0">Secure access to InsurAI dashboard</p>
              </div>
              ...
              <form onSubmit={handleLogin} autoComplete="on">
                ...
                <button
                  ...
                  style={{
                    borderRadius: "10px",
                    background: "linear-gradient(135deg, #f7160bff, #5b0303ff)",
                    border: "none",
                    color: "white",
                    padding: "14px",
                    fontSize: "1rem",
