...
export default function AgentLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch("https://insurai-policy-automation-system-backend.onrender.com/agent/login", {
        method: "POST",
  ...
  return (
    <div
      ...
      style={{
        minHeight: "100vh",
        width: "100vw",
        background: "linear-gradient(135deg, #023429ff 0%, #91a905ff 100%)",
        padding: "0",
        margin: "0",
      ...
      >
        <div className="row g-0">
          ...
          <div 
            ...
            style={{
              background: "linear-gradient(135deg, #084206ff 0%, #497547ff 100%)",
              position: "relative",
              overflow: "hidden",
            }}
          >
